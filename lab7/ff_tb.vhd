...
begin
-- SR FF test
S <= '1'; R <= '0'; wait for 10 ns ; -- Set
S <= '0'; R <= '1'; wait for 10 ns ; -- Reset
S <= '0'; R <= '0'; wait for 10 ns ; -- Hold
-- D FF test
D <= '1'; wait for 10 ns ;
D <= '0'; wait for 10 ns ;
-- JK FF test
J <= '1'; K <= '0'; wait for 10 ns ; -- Set
J <= '1'; K <= '1'; wait for 10 ns ; -- Toggle
J <= '0'; K <= '1'; wait for 10 ns ; -- Reset
-- T FF test
T <= '1'; wait for 10 ns ; -- Toggle twice
T <= '0'; wait for 10 ns ; -- Hold
wait ;
end process ;
